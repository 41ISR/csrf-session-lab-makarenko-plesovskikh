...
const Game = () => {
    ...
    useEffect(() => {
        setCurrentEscore(user.user.escore)
    }, [user])
    const handleEscore = () => {
        setCurrentEscore(currentEscore + 1)
    }
    ...
    const handleSubmit = async () => {
        try {
            const res = await fetch("https://potential-cod-97rq6j9575v3955p-3000.app.github.dev/api/spin",
                {
                    method: "POST",
                    credentials: "include",
                    headers: {
                    ...
                    body: JSON.stringify({esocre: useAppStore.getState().currentEscore})
                }
            )
        ...
        <div id="game-screen" className="screen">
            <div className="game-container">
                ...
                <div className="slot-machine">
                    ...
                    <div className="win-message" id="win-message"></div>
